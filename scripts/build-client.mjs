...
const moduleNames = ['project-domain.cjs', 'project-adapter.cjs', 'project-retrieval.cjs', 'writing-skill-router.cjs', 'skill-route-presentation.cjs', 'ask-context.cjs', 'write-context.cjs', 'proposal-domain.cjs', 'patch-view.cjs', 'proposal-review.cjs', 'conversation-adapter.cjs', 'index.cjs']
