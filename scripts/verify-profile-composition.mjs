...
assert.match(result.stdout, /- id: skill-filesystem\s+name: '@deepseek-ai\/dsh-skill-filesystem'/)
assert.match(result.stdout, /- id: tool-skill\s+name: '@deepseek-ai\/dsh-tool-skill'/)
